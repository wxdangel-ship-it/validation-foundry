  ...
  var MATRIX_ATTRIBUTES = {
    ...
    update(attribute, { startRow, endRow }) {
      ...
      if (attribute.constant) {
        ...
        const { iterable, objectInfo } = (0, import_core3.createIterable)(data, startRow, endRow);
...
`;
  ...
  function normalizeGeometryAttributes(attributes) {
    ...
    import_core4.log.assert(positionAttribute, 'no "postions" or "POSITION" attribute in mesh');
  ...
  var SimpleMeshLayer = class extends import_core4.Layer {
    getShaders() {
      return super.getShaders({
        vs: simple_mesh_layer_vertex_glsl_default,
        fs: simple_mesh_layer_fragment_glsl_default,
        modules: [import_core4.project32, phongMaterial, import_core4.picking, simpleMeshUniforms]
      });
    }
    getBounds() {
    ...
    updateState(params) {
      ...
      if (props.texture !== oldProps.texture && props.texture instanceof import_core5.Texture) {
  ...
  function parseMaterial(device, material, parsedMaterial) {
    ...
    if (material.normalTexture) {
      ...
      parsedMaterial.uniforms.normalScale = scale5;
    }
    ...
    switch (material.alphaMode || "MASK") {
      case "MASK":
        ...
        break;
      case "BLEND":
        import_core6.log.warn("glTF BLEND alphaMode might not work well because it requires mesh sorting")();
...
`
  ...
  function interpolate(time, { input, interpolation, output }, target, path) {
    ...
    if (!Array.isArray(target[path])) {
      switch (path) {
        ...
        case "scale":
          ...
          break;
        default:
          import_core9.log.warn(`Bad animation path ${path}`)();
      }
    }
    ...
    switch (interpolation) {
      ...
      case "CUBICSPLINE":
        ...
        break;
      default:
        import_core9.log.warn(`Interpolation ${interpolation} not supported`)();
        break;
    }
  }
  ...
  var GLTFAnimator = class {
    ...
    animate(time) {
      import_core11.log.warn("GLTFAnimator#animate is deprecated. Use GLTFAnimator#setTime instead")();
      this.setTime(time);
    }
    setTime(time) {
...
`;
  ...
  var ScenegraphLayer = class extends import_core14.Layer {
    getShaders() {
      const defines = {};
      let pbr;
      ...
      const modules = [import_core14.project32, import_core14.picking, scenegraphUniforms, pbr];
    ...
    _updateScenegraph() {
      ...
      if (scenegraph instanceof import_engine4.GroupNode) {
        ...
        import_core14.log.warn("invalid scenegraph:", scenegraph)();
      }
    }
      ...
      Object.keys(animationsProp).sort().forEach((key) => {
        ...
        if (key === "*") {
          ...
          if (number >= 0 && number < animations.length) {
            ...
            import_core14.log.warn(`animation ${key} not found`)();
          }
        } else {
